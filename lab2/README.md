...
## Zadanie 2 - Napisz program, który kopiuje zawartość jednego pliku do drugiego, odwróconą bajt po bajcie
...
## Zadanie 3 - Napisz program, który będzie przeglądał bieżący katalog, korzystając z funkcji opendir(), readdir() i stat()
...
## Zadanie 4 - Napisz program, który będzie przeglądał katalog podany jako argument wywołania i jego podkatalogi, korzystając z funkcji ftw() (uproszczonej wersji funkcji nftw())
